...
public class RichiestaSupportoService extends AbstractService {
        ...
        public RichiestaSupportoService(IUnitOfWork unitOfWork, LinkStrategyContext linkStrategyContext) {
                super(unitOfWork);
        ...
        public RichiestaSupporto creaRichiesta(CreaRichiestaSupportoRequest request, String richiedenteId) {
                Partecipazione partecipazione = findPartecipazioneOrThrow(request.getTeamId(),
                                request.getHackathonId());
                User richiedente = findUserOrThrow(richiedenteId);

                validateUserInTeam(partecipazione.getTeam(), richiedenteId,
        ...
        public List<RichiestaSupportoDTO> getRichiestePerMentore(String hackathonId, String mentorId) {
                ...
                validateUserIsMentorInHackathon(hackathon, mentorId, "L'utente non è un mentore per questo Hackathon");
        ...
        public RichiestaSupporto proponiCall(ProponiCallRequest request, String mentorId) {
                if (!linkStrategyContext.validate(request.getLinkCall(), List.of("Google Meet", "Webex"))) {
                ...
                validateUserIsMentorInHackathon(richiesta.getHackathon(), mentorId,
        ...
        public List<RichiestaSupportoDTO> getRichiesteGestitePerTeam(String hackathonId, String teamId, String userId) {
                ...
                validateUserInTeam(team, userId, "L'utente non appartiene al team specificato.");
