...
public class MainHackathonTests {
    ...
    private static void setupEnvironment() {
        ...
        mentoreValido = new User("Pippo", "Grind", "Pippo@test.com", Ruolo.MENTORE);
        // Usiamo un ruolo 'sbagliato' per testare i permessi (es. riutilizziamo Giudice
        // come fosse un semplice user se non abbiamo PARTECIPANTE)
    ...
    private static void testErroreDateIncoerenti() {
        ...
        CreaHackathonRequest request = new CreaHackathonRequest(
                ...
                "Online", 1000, 4,
                organizzatoreValido.getId(), giudiceValido.getId(), List.of(mentoreValido.getId()));
